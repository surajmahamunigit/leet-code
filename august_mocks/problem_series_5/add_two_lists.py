# 12.09
# given two lists and asked to add them and return result
...
class Solution:
    def addTwoNumbers(self, l1: ListNode, l2: ListNode) -> ListNode:
        """Add two linked list representing two numbers and return result in list format.

        Args:
            l1, l2: head nodes of given lists

        Returns:
            add two lists and return result in form of list

        Time: O(m+n) - m, n = lengths of given linked lists
        Space: O(1)
        """
