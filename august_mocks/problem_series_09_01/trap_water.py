...
class Solution:
    def trapWater(self, height: list[int]) -> int:
        """Find total water trapped between the bars.

        Args:
            height: integer array representing bar heights
...
# 12.25 -> 9 min
# can you explain me short, why do we have if and else block like that. and whats importance of it.