...
class Solution:
    def characterReplacement(self, s: str, k: int) -> int:
        """Find the length of longest substring with unique character and k replacements.
        ...
        Returns:
            length of longest substring with unique character and k replacements
